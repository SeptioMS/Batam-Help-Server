...
$query  = "SELECT * FROM pelaporan where kecamatan = '%$kecamatan%' and status_aduan='Belum ditangani' Order By idpelaporan DESC LIMIT $posisi,$batas";
...
echo "</table>";
$query2     = mysqli_query($con, "select * from pelaporan where kecamatan = '%$kecamatan%' and status_aduan='Belum ditangani' Order By idpelaporan");

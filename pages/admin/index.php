...
<?php 	
   	                if(!isset($_GET["page"])){
   	                    require "data_laporan.php";
   	                }else {
   	                	if($_GET['page'] == "beranda")
   	                    {
   	                        require "data_laporan.php";
   	                    } 
   	                    if($_GET['page'] == "masyarakat")
   	                    {
   	                        require "masyarakat.php";
   	                    }
						if($_GET['page'] == "instansi")
   	                    {
   	                        require "instansi.html";
   	                    }
						if($_GET['page'] == "ubah_instansi")
   	                    {
   	                        require "ubah_instansi.php";
   	                    }
					}
				?>

...
<link rel="stylesheet" href="../../dist/cetakjs/themes/base/jquery.ui.all.css">
	<script src="../../dist/cetakjs/js/jquery-1.7.2.js"></script>
	<script src="../../dist/cetakjs/ui/jquery.ui.core.js"></script>
	<script src="../../dist/cetakjs/ui/jquery.ui.datepicker.js"></script>
	...
	function Start(page) {
OpenWin = this.open(page, "CtrlWindow", "scrollbars=yes,resizable=no,width=800,height=600,top=50, left=300");
}
	</script>
  ...
  <body class="hold-transition skin-green sidebar-mini">
    ...
    <div class="wrapper">
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <li><a href="cetaklaporan.php"=cetak"><i class="fa fa-link"></i> <span>Cetak Pelaporan</span></a></li>
          </ul>
          <!-- /.sidebar-menu -->
        </section>
        <!-- /.sidebar -->
	...
	<h1 align="center">Cetak Laporan</h1>
   	...
   	<div align="center">
		<h4><a href="javascript:Start('Laporan_Belumditangani.php')">Klik disini </a>untuk mencetak laporan yang belum ditangani
	    </h4>
		<p>__________________________________________________________________________________________________</p>
		</div>
		<div align="center">
		<h4>Cetak Laporan Harian</h4>
		<form action="Cetak_laporan_tanggal.php" method="POST">
			<input type="text" autocomplete="off" id="datepicker" name="dari">
